...
exports.createUserZodSchema = zod_1.default.object({
    ...
    name: zod_1.default.string().min(5, "Name must be at least 5 characters long"),
    ...
    gender: zod_1.default.enum([enums_1.Gender.Men, enums_1.Gender.Women, enums_1.Gender.Unisex], `Gender must be one of: ${enums_1.Gender.Men}, ${enums_1.Gender.Women}, or ${enums_1.Gender.Unisex}`),
